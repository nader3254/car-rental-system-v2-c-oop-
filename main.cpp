...
void readUserPass()
{
  ...
  //  cout<<x;
 /* 
   if(strstr(x,"pass") == "pass")
   {
	   cout <<"موجود يا معلم اتفضل خش بيتك و مطرحك \n";
	   cout<<"lets gooo...............";
   }
cout<<"lets gooo 2...............";
	while(1);
...
void customerData()
{
	...
	ifs.close();
	system("cls");
	cout<<"customer data initialized successfuly....";
}
...
void availCar ()
{
	...
	ifs.close();
	system("cls");
	cout<<"available cars initialized successfuly....";
}
...
void carData ()
{
	...
	ifs.close();
	cout<<"\n\t  car rental initialized successfuly......";
}
